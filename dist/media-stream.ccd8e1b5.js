...
},{"./RTCConnectionManager":"../node_modules/rtc-socket-connector-client/dist/RTCConnectionManager.js"}],"media-stream.ts":[function(require,module,exports) {
"use strict";
...
function main() {
  ...
  var targetVideo = document.getElementById("targetVideo"); // 1. Connect to socket.io server

  var socket = (0, _socket.io)("http://localhost:5000");
  var rtcConnectionManager;
  socket.on("connect", function () {
    socketIdSpan.innerHTML = socket.id;
  }); // 2. Define RTCConnectionHandler

  var rtcConnectionHandlers = {
    onTrack: function onTrack(socketId, streams) {
      setStreamToVideoElement(streams[0], targetVideo);
      console.log("track from socketId: ".concat(socketId));
    }
  }; // 3. Create RTCConnectionManager

  rtcConnectionManager = (0, _rtcSocketConnectorClient.createRTCConnectionManager)(socket, rtcConnectionHandlers); // 4. Set MediaStream

  getUserMedia().then(function (myMediaStream) {
...
main();
},{"socket.io-client":"../node_modules/socket.io-client/build/esm/index.js","rtc-socket-connector-client":"../node_modules/rtc-socket-connector-client/dist/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","media-stream.ts"], null)
//# sourceMappingURL=/media-stream.ccd8e1b5.js.map