...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/rtc-socket-connector-client/dist/RTCConnectionStorage.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/rtc-socket-connector-client/dist/RTCConnectionManager.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./RTCConnectionStorage":"../node_modules/rtc-socket-connector-client/dist/RTCConnectionStorage.js"}],"../node_modules/rtc-socket-connector-client/dist/index.js":[function(require,module,exports) {
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.RTCConnectionManager = exports.createRTCConnectionManager = void 0;
const RTCConnectionManager_1 = __importDefault(require("./RTCConnectionManager"));
exports.RTCConnectionManager = RTCConnectionManager_1.default;
function createRTCConnectionManager(socket, connectionHandler, rtcConfiguration) {
    const rtcConnectionManager = new RTCConnectionManager_1.default(socket, connectionHandler, rtcConfiguration);
    return rtcConnectionManager;
}
exports.createRTCConnectionManager = createRTCConnectionManager;

},{"./RTCConnectionManager":"../node_modules/rtc-socket-connector-client/dist/RTCConnectionManager.js"}],"../node_modules/engine.io-parser/build/esm/commons.js":[function(require,module,exports) {
"use strict";
 ...
 * @public
 */
},{"./url.js":"../node_modules/socket.io-client/build/esm/url.js","./manager.js":"../node_modules/socket.io-client/build/esm/manager.js","./socket.js":"../node_modules/socket.io-client/build/esm/socket.js","socket.io-parser":"../node_modules/socket.io-client/node_modules/socket.io-parser/build/esm/index.js"}],"web-rtc-connection.ts":[function(require,module,exports) {
"use strict";

var _rtcSocketConnectorClient = require("rtc-socket-connector-client");
...
function main() {
  ...
  var socketId = document.getElementById("socketId"); // 1. Connect to socket.io server

  var socket = (0, _socket.io)("http://localhost:5000");
  socket.on("connect", handleSocketConnect); // 2. Define RTCConnectionHandler

  var rtcConnectionHandler = {
    onRTCPeerConnection: function onRTCPeerConnection(socketId, rtcPeerConnection) {
      rtcPeerConnection.addEventListener("connectionstatechange", function () {
        console.log("connectionstatechange::: socket id:".concat(socketId, " state:").concat(rtcPeerConnection.connectionState));
  ...
  var rtcConnectionManager = (0, _rtcSocketConnectorClient.createRTCConnectionManager)(socket, rtcConnectionHandler);
...
main();
},{"rtc-socket-connector-client":"../node_modules/rtc-socket-connector-client/dist/index.js","socket.io-client":"../node_modules/socket.io-client/build/esm/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","web-rtc-connection.ts"], null)
//# sourceMappingURL=/web-rtc-connection.d4c5c6b7.js.map